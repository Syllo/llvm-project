...
; CHECK-NEXT:    [[ACC_0_RIPPLE_VECTORIZED]] = call <8 x float> @llvm.masked.gather.v8f32.v8p0(<8 x ptr> [[ARRAYIDX_RIPPLE_LS_INSTANCE1_RIPPLE_BRANCH_CLONE]], i32 4, <8 x i1> splat (i1 true), <8 x float> poison)
...
; CHECK-NEXT:    br label %[[IF_END_RIPPLE_PREDSPLIT_RIPPLE_BRANCH_CLONE8:.*]]
; CHECK:       [[IF_END_RIPPLE_PREDSPLIT_RIPPLE_BRANCH_CLONE8]]:
