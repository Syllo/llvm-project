...
//CHECK-NEXT: |   `-ElaboratedType {{.*}} 'struct ripple_block_shape' sugar
//CHECK-NEXT: |     `-RecordType {{.*}} 'struct ripple_block_shape'
...
//CHECK-NEXT: |   |       |-ImplicitCastExpr {{.*}} <col:20> 'void *(*)(unsigned long, unsigned long, unsigned long, unsigned long, unsigned long, unsigned long, unsigned long, unsigned long, unsigned long, unsigned long, unsigned long)' <BuiltinFnToFnPtr>
//CHECK-NEXT: |   |       | `-DeclRefExpr {{.*}} <col:20> '<builtin fn type>' Function {{.*}} '__builtin_ripple_set_shape' 'void *(unsigned long, unsigned long, unsigned long, unsigned long, unsigned long, unsigned long, unsigned long, unsigned long, unsigned long, unsigned long, unsigned long)'
//CHECK-NEXT: |   |       |-ImplicitCastExpr {{.*}} <col:47, col:52> 'unsigned long' <IntegralCast>
//CHECK-NEXT: |   |       | `-ParenExpr {{.*}} <col:47, col:52> 'int'
//CHECK-NEXT: |   |       |   `-IntegerLiteral {{.*}} <line:9:46> 'int' 0
//CHECK-NEXT: |   |       |-ImplicitCastExpr {{.*}} <line:4:55, col:60> 'unsigned long' <IntegralCast>
//CHECK-NEXT: |   |       | `-ParenExpr {{.*}} <col:55, col:60> 'int'
//CHECK-NEXT: |   |       |   `-IntegerLiteral {{.*}} <line:9:49> 'int' 4
//CHECK-NEXT: |   |       |-ImplicitCastExpr {{.*}} <line:4:63> 'unsigned long' <IntegralCast>
//CHECK-NEXT: |   |       | `-IntegerLiteral {{.*}} <col:63> 'int' 1
//CHECK-NEXT: |   |       |-ImplicitCastExpr {{.*}} <col:66> 'unsigned long' <IntegralCast>
//CHECK-NEXT: |   |       | `-IntegerLiteral {{.*}} <col:66> 'int' 1
//CHECK-NEXT: |   |       |-ImplicitCastExpr {{.*}} <col:69> 'unsigned long' <IntegralCast>
//CHECK-NEXT: |   |       | `-IntegerLiteral {{.*}} <col:69> 'int' 1
//CHECK-NEXT: |   |       |-ImplicitCastExpr {{.*}} <col:72> 'unsigned long' <IntegralCast>
//CHECK-NEXT: |   |       | `-IntegerLiteral {{.*}} <col:72> 'int' 1
//CHECK-NEXT: |   |       |-ImplicitCastExpr {{.*}} <col:75> 'unsigned long' <IntegralCast>
//CHECK-NEXT: |   |       | `-IntegerLiteral {{.*}} <col:75> 'int' 1
//CHECK-NEXT: |   |       |-ImplicitCastExpr {{.*}} <col:78> 'unsigned long' <IntegralCast>
//CHECK-NEXT: |   |       | `-IntegerLiteral {{.*}} <col:78> 'int' 1
//CHECK-NEXT: |   |       |-ImplicitCastExpr {{.*}} <col:81> 'unsigned long' <IntegralCast>
//CHECK-NEXT: |   |       | `-IntegerLiteral {{.*}} <col:81> 'int' 1
//CHECK-NEXT: |   |       |-ImplicitCastExpr {{.*}} <col:84> 'unsigned long' <IntegralCast>
//CHECK-NEXT: |   |       | `-IntegerLiteral {{.*}} <col:84> 'int' 1
//CHECK-NEXT: |   |       `-ImplicitCastExpr {{.*}} <col:87> 'unsigned long' <IntegralCast>
...
//CHECK-NEXT: |     |       `-IntegerLiteral {{.*}} <col:26> 'int' 1
//CHECK-NEXT: |     `-NullStmt {{.*}} <line:12:5>
//CHECK-NEXT: |-FunctionDecl {{.*}} <line:4:20> col:20 implicit used __builtin_ripple_set_shape 'void *(unsigned long, unsigned long, unsigned long, unsigned long, unsigned long, unsigned long, unsigned long, unsigned long, unsigned long, unsigned long, unsigned long)' extern
//CHECK-NEXT: | |-ParmVarDecl {{.*}} <<invalid sloc>> <invalid sloc> 'unsigned long'
//CHECK-NEXT: | |-ParmVarDecl {{.*}} <<invalid sloc>> <invalid sloc> 'unsigned long'
//CHECK-NEXT: | |-ParmVarDecl {{.*}} <<invalid sloc>> <invalid sloc> 'unsigned long'
//CHECK-NEXT: | |-ParmVarDecl {{.*}} <<invalid sloc>> <invalid sloc> 'unsigned long'
//CHECK-NEXT: | |-ParmVarDecl {{.*}} <<invalid sloc>> <invalid sloc> 'unsigned long'
...
//CHECK-NEXT: |-FunctionDecl {{.*}} <line:10:1> col:1 implicit used __builtin_ripple_get_index 'unsigned long (void *, unsigned long)' extern
//CHECK-NEXT: | |-ParmVarDecl {{.*}} <<invalid sloc>> <invalid sloc> 'void *'
//CHECK-NEXT: | |-ParmVarDecl {{.*}} <<invalid sloc>> <invalid sloc> 'unsigned long'
//CHECK-NEXT: | |-BuiltinAttr {{.*}} <<invalid sloc>> Implicit {{[0-9]+}}
//CHECK-NEXT: | `-NoThrowAttr {{.*}} <col:1> Implicit
//CHECK-NEXT: |-FunctionDecl {{.*}} <col:1> col:1 implicit used __builtin_ripple_get_size 'unsigned long (void *, unsigned long)' extern
//CHECK-NEXT: | |-ParmVarDecl {{.*}} <<invalid sloc>> <invalid sloc> 'void *'
//CHECK-NEXT: | |-ParmVarDecl {{.*}} <<invalid sloc>> <invalid sloc> 'unsigned long'
//CHECK-NEXT: | |-BuiltinAttr {{.*}} <<invalid sloc>> Implicit {{[0-9]+}}
//CHECK-NEXT: | `-NoThrowAttr {{.*}} <col:1> Implicit
