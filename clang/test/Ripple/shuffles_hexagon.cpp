...
// CHECK: check_shuffle_fptr___bf16
// CHECK: llvm.ripple.shuffle.f32(float %{{.*}}, float %{{.*}}, i1 false, ptr
// CHECK: ret
// CHECK: check_shuffle_pair_fptr___bf16
// CHECK: llvm.ripple.shuffle.f32(float %{{.*}}, float %{{.*}}, i1 true, ptr
// CHECK: ret
