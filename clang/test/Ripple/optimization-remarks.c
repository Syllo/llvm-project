...
// SUCCESS-NEXT:    34 |         __builtin_abs(ripple_add_sat((int)cosVal, (int)cosVal));
// SUCCESS-NEXT:       |                       ^
// SUCCESS-NEXT: optimization-remarks.c:36:23: remark: instruction promoted to tensor {shape: (Tensor[32], Tensor[32]) -> Tensor[32]} [-Rpass=ripple]
...
// SUCCESS-NEXT:    45 |   c[ripple_id(BS2, 0)] += ripple_reduceadd(0x1, c[ripple_id(BS2, 0)] + 32.f);
// SUCCESS-NEXT:       |                           ^
// SUCCESS-NEXT: optimization-remarks.c:48:3: remark: instruction promoted to tensor {shape: (Scalar->Tensor[32][4], Tensor[32][4]) -> Tensor[32][4]} [-Rpass=ripple]
